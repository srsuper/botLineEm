...
settings = {
    ...
    "message":"บัญชีนี้ถูกป้องกันโดย  คุณออ๊ดเมียตบยังหลบได้ Bot ระบบได้บล็อคคุณอัตโนมัติ!",
    "comment":"""By. คุณออ๊ดเมียตบยังหลบได้ Bot:
╔══════════════┓
╠     คุณออ๊ดเมียตบยังหลบได้ Bot
╚══════════════┛""",
    "userAgent": [
...
#==============================================================================#
                    ...
                    try:
                        ...
                        ret_ = "╔══[ 🔱🔯 คุณออ๊ดเมียตบยังหลบได้ Bot 🔯🔱]"
...
#===========
                    ...
                    line.sendMessage(to,"🔱🔯 คุณออ๊ดเมียตบยังหลบได้ Bot 🔯🔱")
...
#==============================================================================#
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                               ...
                               mi_d = Mids[:33]
                               line.createGroup("คุณออ๊ดLมียตบVงหลบได้",mi_d)
                    ...
                    for g in gs.members:
                        if _nametarget == g.displayName:
                           line.sendText(g.mid,"คุณออ๊ดLมียตบVงหลบได้")
                           line.sendText(g.mid,"คุณออ๊ดLมียตบVงหลบได้")
                           line.sendText(g.mid,"คุณออ๊ดLมียตบVงหลบได้")
                           line.sendText(g.mid,"คุณออ๊ดLมียตบVงหลบได้")
                           line.sendText(g.mid,"คุณออ๊ดLมียตบVงหลบได้")
...
#==============================================================================#
                    ...
                    for k in range(0, len(bulan)):
                        if bln == str(k): bln = bulan[k-1]
                    readTime = "❋คุณออ๊ดLมียตบVงหลบได้\n\n🌿🌸🍃🌸🍃🌸🍃🌸🍃🌸🍃🌸🌿" + "\n\n🍁" + hasil + "\n🍁 ที่ " + timeNow.strftime('%d') + " - " + bln + " - " + timeNow.strftime('%Y')  + "\n🍁 เวลา : [ " + timeNow.strftime('%H:%M:%S') + " ]" + "🌿🌸🍃🌸🍃🌸🍃🌸🍃🌸🍃🌸🌿" + "\n\nBY: ❋คุณออ๊ดLมียตบVงหลบได้"
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         ...
                         line.sendMessage(msg.to, "คุณออ๊ดLมียตบVงหลบได้\n❋ตั้งข้อความเมื่อมีคนแอด❋\n\n{}".format(str(spl)))
