...
line.log("Timeline Token : XuAPgE5eH13Hbgj7mSSCmqe5wheTgVDhiE805ypPKx1hyHXCXLgshl02rpLCe+rUUVTfBE6SkoXrkRD0c1omm6o8RFZMgCETtwF7nDTKSg3PDQG6OIHE2npC1e3YfWXhvBMcXBwFrF5zE8s9T83cgQdB04t89/1O/w1cDnyilFU= " + str(line.tl.channelAccessToken))
...
mulai = time.time() 
dangerMessage = ["เอ็มเสียใจด้วยครับ","โชคดีครับ","ชีวิตยังมีงวดหน้าเสมอ",".winebot",".kickall","mayhem","kick on","makasih :d","!kickall","nuke","บิน",".???","Kickall","บินไปดิ","Kickword","kickword","!kickword","/kickall"]
dangerMessage2 = ["ว่างัยจ๊ะทิรักของเอ็ม 5555","คร้าบบ","ว่างัยน่ะ!!.. รักเอ็มหรออ อิอิ","ว่างัยเอ๋ยย เอ็มรอฟังอยู่","เอ็มมาแล้วคร้าบบ","แอบรักเอ็มอยู่หราาา","แอบชอบเอ็มหราา","รักเอ็มหรอ","คิดถึงเอ็มมากเลยหรอ"]
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                ...
                if msg.text in ["555","5555","55555","55+","55++","555+","555++","5555+","5555++"]:
                    line.sendText(msg.to,"เอ็มว่าไปหาหมอบ้างน่ะ อิอิ")				
                if msg.text in dangerMessage:
                    random.choice(Rfu).kickoutFromGroup(receiver,[sender])
                    random.choice(Rfu).sendText(msg.to,"ตรวจพบคำสั่งของบอทลบกลุ่ม  เอ็ม Bot Self จำเป็นต้องนำออกเพื่อความปลอดภัยของสมาชิก (｀・ω・´)")										
        if op.type == 17:
          if settings["Wc"] == True:
