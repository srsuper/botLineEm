...
line = LINE('XuAPgE5eH13Hbgj7mSSCmqe5wheTgVDhiE805ypPKx1hyHXCXLgshl02rpLCe+rUUVTfBE6SkoXrkRD0c1omm6o8RFZMgCETtwF7nDTKSg3PDQG6OIHE2npC1e3YfWXhvBMcXBwFrF5zE8s9T83cgQdB04t89/1O/w1cDnyilFU=')
...
settings = {
    ...
    "man2":"ตั้งข้อความ",
    "man3":"ตั้งข้อความ",
    "message":"บัญชีนี้ได้การป้องกัน💢โดย คุณออ๊ด Bot Self ระบบได้ทำการบล็อคคุณอัตโนมัติ\nติดต่อคุณออ๊ดได้ที่ Em_club0075",
...
mulai = time.time() 
dangerMessage = ["คุณออ๊ดเสียใจด้วยครับ","โชคดีครับ","ชีวิตยังมีงวดหน้าเสมอ",".winebot",".kickall","mayhem","kick on","makasih :d","!kickall","nuke","บิน",".???","Kickall","บินไปดิ","Kickword","kickword","!kickword","/kickall"]
dangerMessage2 = ["ว่างัยจ๊ะทิรักของคุณออ๊ด 5555","คร้าบบ","ว่างัยน่ะ!!.. รักคุณออ๊ดหรออ อิอิ","ว่างัยเอ๋ยย คุณออ๊ดรอฟังอยู่","คุณออ๊ดมาแล้วคร้าบบ","แอบรักคุณออ๊ดอยู่หราาา","แอบชอบคุณออ๊ดหราา","รักคุณออ๊ดหรอ","คิดถึงคุณออ๊ดมากเลยหรอ"]
...
def listgrup():
    listGrup =  """💢คำสั่งตั้งค่า คุณออ๊ดBotSelf💢
...
def socmedia():
    socMedia = """💌คำสั่งแทค คุณออ๊ดBotSelf💌
⭐คท @ ➠ แทคคนที่จะเอาคท
⭐มิด @  ➠ ลงmidคนอื่น
⭐ชื่อ @ ➠ ลงชื่อคนอื่น
⭐ตัส @ ➠ ลงตัสคนอื่น
...
def helpset():
    helpSet = """🔱🔱คำสั่ง คุณออ๊ดBotSelf🔱🔱
🛂 คุณออ๊ด  🔀 คอนแทคคุณออ๊ด
🛂 มิด  🔀 MID เรา
🛂 ชื่อ  🔀 ชื่อเรา
🛂 ตัส  🔀 สถานะเรา
🛂 ตรวจสอบ  🔀 ผู้ตรวจสอบ
...
def helpkicker():
    helpKicker = """⏳คำสั่งค้นหา คุณออ๊ดBotSelf⏳
...
def helpsetting():
    helpSetting = """⚓คำสั่งกลุ่ม คุณออ๊ดBotSelf⚓
🍁 กลุ่ม ➠ ข้อมูลกลุ่ม
🍁 ไอดีกลุ่ม ➠ไอดีห้อง
🍁 ชื่อกลุ่ม ➠ ชื่อห้อง
...
def helptexttospeech():
    helpTextToSpeech =   """⚡คำสั่งเลียนแบบคุณออ๊ดBotSelf⚡
🔁 เลียนแบบ on/off 
🔁 เลียนแบบ 
🔁 เพิ่มเลียนแบบ (@) 
🔁 ลบเลียนแบบ (@)"""
...
#===============หาชื่อล่อนหน===============================================================#
                    ...
                    ki.sendMessage(to, "คุณออ๊ด BotSelfยังอยู่ครับ")
                elif text.lower() == 'เทส':
                    line.sendMessage(to, "คุณออ๊ด BotSelfกำลังโหลด:▒...0%")
                    ...
                    line.sendMessage(to, " 🔱คุณออ๊ด BotSelf ยังอยู่ครับ✔")
                    ...
                    start = time.time()
                    line.sendMessage(to,"ความเร็วของ คุณออ๊ด Bot Self...")
...
#==============================================================================#   
                    ...
                    with requests.session() as web:
                        ...
                        ret_ = "╔══[ ผลการค้นหาของ คุณออ๊ดBotSelf ]"
                        datas = []
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                ...
                if msg.text in ["speed","sp","Speed","สปีด","!speed","/speed"]:
                    line.sendText(msg.to,"แรงขนาดนี้ คุณออ๊ดนี้ไลค์เลย👍")
                ...
                if msg.text in ["555","5555","55555","55+","55++","555+","555++","5555+","5555++"]:
                    line.sendText(msg.to,"คุณออ๊ดว่าไปหาหมอบ้างน่ะ อิอิ")				
                if msg.text in dangerMessage:
                    random.choice(Rfu).kickoutFromGroup(receiver,[sender])
                    random.choice(Rfu).sendText(msg.to,"ตรวจพบคำสั่งของบอทลบกลุ่ม  คุณออ๊ด Bot Self จำเป็นต้องนำออกเพื่อความปลอดภัยของสมาชิก (｀・ω・´)")										
        if op.type == 17:
          if settings["Wc"] == True:
                ...
                if RfuCctv['cyduk'][op.param1]==True:
                    if op.param1 in RfuCctv['point']:
                        ...
                        if Name in RfuCctv['sidermem'][op.param1]:
                            ...
                            pref=['สวัสดีครับคนอ่าน➡','ตร๊ะ!..เอ๋!!..😝➡','หวัดดีจร้า💖➡','คุณออ๊ดเห็นนะ อิอิ..😝➡','แอบทำมัย? มาคุยกันหน่อย➡','แอบแฟนเล่นหราา💨➡','คุณออ๊ดรู้นะว่าคัยอ่าน👉➡','เล่นซ่อนแอบหรอคร้าบบ👻➡','มาคุยกับเค้าหน่อย➡','นั่นแน่ แอบหราาา➡']
